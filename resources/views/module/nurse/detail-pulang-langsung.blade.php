<form class="form-horizontal form-label-left"
    ...
    <div class="modal-body">
        <fieldset class="mb-4">
            ...
            <input type="hidden"  name="islangsung" id="islangsung"  value="true" class="form-control">
            <input type="hidden"  name="norecorder" id="norecorder"  value="{{ $dataRencana->norecorder }}" class="form-control">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="table-responsive">
                    <table class="table m-0">
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <select id="cboKondisi" class="form-control cbo-custom" name="kondisi" required>
                                        ...
                                        @foreach($cbo['kondisiKeluar']  as $k)
                                            <option
                                                {{$dataRencana->objectkondisipasienfk ==  $k->id ? 'selected' : ''  }}
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <select id="cboStatusPulang" class="form-control cbo-custom" name="statuspulang" required>
                                        ...
                                        @foreach($cbo['statusPulang']  as $k)
                                            <option
                                                {{$dataRencana->objectstatuspulangfk ==  $k->id ? 'selected' : ''  }}
                        ...
                        <tr>
                            <th scope="row">Tgl Rencana</th>
                            <td>
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <input type="text" id="tglpulang" name="tglpulang"
                                           class="datetime-custom form-control" value="{{ $dataRencana->tglrencana }}" >
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <input type="text" id="namapembawa" name="namapembawa"
                                           value="{{ $dataRencana->namalengkapambilpasien }}"
                                           placeholder="Pembawa Pulang" class=" form-control" required>
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <select id="cboHubungan" class="form-control cbo-custom" name="hubungankeluarga" >
                                        ...
                                        @foreach($cbo['hubunganKeluarga']  as $k)
                                            <option
                                                {{$dataRencana->objecthubungankeluargaambilpasienfk ==  $k->id ? 'selected' : ''  }}
